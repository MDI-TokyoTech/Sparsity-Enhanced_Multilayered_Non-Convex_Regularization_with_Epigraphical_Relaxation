function [x, time_opt, convergeNum] = ERLiGME_STV_CPU(u_obsv, Phi, Phit, para, u_org, enhance, u_opt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if enhance
    ...
    z_star = func_NN_for_STV(K(P(D(u_opt))), blocksize);
    ...
    x = cell(1, 2);
    x{1} = u_obsv;
    x{2} = 0*func_NN_for_STV(K(P(D(u_obsv))), blocksize);
