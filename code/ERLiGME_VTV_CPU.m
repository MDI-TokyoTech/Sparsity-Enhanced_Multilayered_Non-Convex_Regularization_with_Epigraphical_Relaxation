function [x, time_opt, convergeNum] = ERLiGME_VTV_CPU(u_obsv, Phi, Phit, para, u_org, enhance, u_opt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
prox_psi2{3} = @(z1, z2) Proj_Epigraph_L2_for_VTV_CPU(z1, z2, 1);
