function [x, time_opt, convergeNum] = ERLiGME_DVTV_CPU(u_obsv, Phi, Phit, para, u_org, enhance, u_opt)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
prox_psi2{3} = @(z1, z2) Proj_Epigraph_L2_for_DVTV_CPU(z1, z2, para.wlumi);
...
if enhance
    ...
    z_star = func_L2_for_DVTV(D(C(u_opt)), para.wlumi);
    ...
    x = cell(1, 2);
    x{1} = u_obsv;
    x{2} = 0*func_L2_for_DVTV(D(C(u_opt)), para.wlumi);
