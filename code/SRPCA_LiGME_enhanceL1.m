function [l, s, time_opt, convergeNum] = SRPCA_LiGME_enhanceL1(u_obsv, para, u_org, enhance, rangeConstraint)
%==================================
...
% Psi(L*u) = lambda_1*|| l ||_* + lambda_2 *_|| s ||_1
